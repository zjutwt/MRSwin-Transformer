...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        val_loss, val_acc, p, r, f1= evaluate(model=model,
        ...
        logger.info('Epoch:[{}/{}]\t val_loss={:.3f}\t val_acc={:.3f}\t precision={:.3f}\t recall={:.3f}\t f1={:.3f}'.format(epoch+1, args.epochs, val_loss, val_acc,p,r,f1))
    end = time.time()
    time_train = end - start
    logger.info("Finish training! 模型训练时间:%.2f秒" % (time_train))
